...
Thereafter, we will import the [Bus Stops]{.underline} [Location]{.underline}.
...
1.  DiBiase, D., DeMers, M., Johnson, A., Kemp, K., Luck, A. T., Plewe, B., & Wentz, E. (2023, October). Choropleth Maps: Data Classification. GIS Geography. Retrieved from <https://gisgeography.com/choropleth-maps-data-classification/>

2.  DiBiase, D., DeMers, M., Johnson, A., Kemp, K., Luck, A. T., Plewe, B., & Wentz, E. (2023, November). Spatial Autocorrelation: Moran's I in GIS. GIS Geography. Retrieved from <https://gisgeography.com/spatial-autocorrelation-moran-i-gis/>

3.  Land Transport Authority. (2023). DataMall. Retrieved from <https://datamall.lta.gov.sg/content/datamall/en.html>

4.  Wong, K. (2021, August). Tessellation SF: A Map Design Pattern. Retrieved from <https://urbandatapalette.com/post/2021-08-tessellation-sf/>
