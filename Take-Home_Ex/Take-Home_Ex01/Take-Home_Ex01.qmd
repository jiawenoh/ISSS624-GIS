...
In both cases, since the p-value \< 0.05....
...
## 4.8 Computing local Moran's I

The code chunk below is used to compute the Local Moran's I of percentage of passenger trips at the hexagon level.
...
# add notes on localmoran() function

## 4.9 Mapping the local Moran’s I
...
tmap_arrange(localMI_0609sig_ad.map,localMI_1720sig_ad.map,asp = 1, ncol = 2)
